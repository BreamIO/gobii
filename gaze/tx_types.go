...
type tobiigaze_device_info struct {
	serial_number 		byte[tobiigaze_device_info_max_serial_number_length]
	model 				byte[tobiigaze_device_info_max_model_length]
	generation 			byte[tobiigaze_device_info_max_generation_length]
	firmware_version 	byte[tobiigaze_device_info_max_firmware_length]
}
...
type usb_device_info struct {
	serialNumber	byte[tobii_usb_device_info_max_size]
	productName		byte[tobii_usb_device_info_max_size]
	platformType	byte[tobii_usb_device_info_max_size]
	firmwareVersion byte[tobii_usb_device_info_max_size]
}
